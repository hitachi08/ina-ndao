var Datepicker = (function () {
  ...
  function X(t, s) {
    ...
    if (n.language) {
      ...
      if (
        ...
        (h = Object.assign({ format: P, weekStart: R }, r[I])),
          ...
          D === t.weekStart &&
            ((D = a.weekStart = h.weekStart), (a.weekEnd = J(h.weekStart)));
      }
    }
    if (n.format) {
    ...
    if (
      ...
      n.daysOfWeekHighlighted &&
        ((a.daysOfWeekHighlighted = n.daysOfWeekHighlighted.reduce(q, [])),
    ...
    let M = m;
    if (
      (void 0 !== n.startView && ((M = z(n.startView, M)), delete n.startView),
      M < g ? (M = g) : M > f && (M = f),
      M !== m && (a.startView = M),
      n.prevArrow)
    ) {
  ...
  function xe(e) {
    ...
    if (t !== document.body && t)
      return "visible" !== window.getComputedStyle(t).overflow ? t : xe(t);
  }
  class Me {
    constructor(e) {
      ...
      s.classList.add(`datepicker-${p}`),
        ...
        (this.views = [
          new te(this),
          new se(this),
          new ne(this, { id: 2, name: "years", cellClass: "year", step: 1 }),
          new ne(this, {
            id: 3,
            name: "decades",
            cellClass: "decade",
    ...
    show() {
      ...
      if (e.inline) t.classList.add("active");
        ...
        i !== ke(V(t)) ? (t.dir = i) : t.dir && t.removeAttribute("dir"),
    ...
    place() {
      ...
      "auto" === f &&
        (d < y
          ...
          : d + a > v
          ? ((f = "right"), v < c && (k = v - c))
          : (f = "rtl" === ke(n) ? (c - a < y ? "left" : "right") : "left")),
        "right" === f && (g += h - a),
        (g += k),
