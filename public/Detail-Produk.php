        ...
        <div class="container py-5">
            <div class="row g-3 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="display-1 mb-0 animated slideInLeft" style="font-size: 4rem;">Produk Ina Ndao</h1>
                </div>
                <div class="col-lg-6 animated slideInRight">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
                            ...
                            <li class="breadcrumb-item"><a class="text-primary" href="/Produk-Olahan.php">Produk
                                    Olahan</a>
                            </li>
                            <li class="breadcrumb-item text-secondary active" aria-current="page">Detail Produk</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="gallery-main owl-carousel owl-theme mb-3">
                        <?php if (!empty($produk['gambar'])): ?>
                            <?php foreach ($produk['gambar'] as $idx => $img): ?>
                                <div class="item text-center">
                                    <a href="<?= htmlspecialchars($img['path_gambar']) ?>" class="glightbox"
                                        data-gallery="produk-<?= htmlspecialchars($produk['slug']) ?>">
                                        <img src="<?= htmlspecialchars($img['path_gambar']) ?>"
                                            class="img-fluid img-ori rounded shadow-sm" style="height: 400px;"
                                            alt="<?= htmlspecialchars($produk['nama_produk']) ?> <?= $idx + 1 ?>">
                                    </a>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                    ...
                    <div class="gallery-thumbs owl-carousel owl-theme mt-3">
                        <?php if (!empty($produk['gambar'])): ?>
                            <?php foreach ($produk['gambar'] as $idx => $img): ?>
                                <div class="item">
                                    <img src="<?= htmlspecialchars($img['path_gambar']) ?>" class="img-thumbnail img-thumb"
                                        style="height:70px; object-fit:cover; cursor:pointer;" alt="thumb <?= $idx + 1 ?>">
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <div class="item">
                                <img src="/assets/img/no-image.png" class="img-thumbnail img-thumb"
                                    style="height:70px; object-fit:cover;" alt="no image">
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3 text-start">
                        <div id="qrcode-small" style="display:inline-block; cursor:pointer;" data-bs-toggle="modal"
                    ...
                    <div class="modal modal fade" id="qrModal" tabindex="-1" aria-labelledby="qrModalLabel"
                        aria-hidden="true">
                    ...
                    <div class="d-flex gap-2">
                        <div class="cta-wrap text-start mb-3">
                            <a class="btn btn-order btn-sm" target="_blank"
                                href="https://wa.me/6282145209063?text=Halo%20Ina%20Ndao%2C%20saya%20tertarik%20dengan%20produk%20<?= urlencode($produk['nama_produk']) ?>">
                    ...
                    <div class="kain-detail mb-3">
                        ...
                        <table class="table table-sm table-borderless mt-2">
                            <tr>
                                <td style="width:30%;"><strong>Deskripsi</strong></td>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($produk['stok'] ?? $produk['stok_kain'] ?? '0') ?></td>
                            </tr>
                        </table>
                    </div>
