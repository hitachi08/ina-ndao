            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                Rr(
                  ...
                  (n) =>
                    me(t, (t) =>
                      ((t, n) => (rv(e, t.dom, n) ? I.some(n) : I.none()))(n, t)
                    ),
                  n
                )
              )
  ...
  const bx = (e, t) => {
    ...
    Cx = (e) => {
      ...
      const r = px(),
        ...
        l = (e, t, n) => {
          const o = `src="${n}"${
            n === rn.transparentSrc ? ' data-mce-placeholder="1"' : ""
          }`;
          return (
            (e = i(e, `src="${t}"`, o)),
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return Tu(e, n, s)
                ...
                .fold(
                  () => o.map(sk),
                  (r) => nk(t, n, r).map(D(ik, e, t, n, s, r)).filter(D(lk, o))
                )
                .filter(tk);
            })(e, t, n, s, o)
          );
        ...
        ? ((e, t) =>
            t.startSummary.exists((t) =>
              ((e, t) =>
                Fu(t).exists(
                  (n) =>
                    (ms(n.getNode()) && Mu(t, n).exists((t) => t.isEqual(e))) ||
                    n.isEqual(e)
                ))(e, t)
            ))(s, t) ||
          ((e, t, n) =>
