...
<head>
    ...
    <style>
        ...
        .text-truncate2 { display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; }
        .detail-image-modal { width: 48%; height: 50%; object-fit: cover; transition: all 0.4s ease; cursor: pointer; position: relative; z-index: 1; }
    </style>
</head>
<body>
