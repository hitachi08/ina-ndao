    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <!-- Event -->
                <li class="nav-item">
                    <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-event">
                        <span>
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="multi-level collapse" id="submenu-event">
                        <ul class="flex-column nav">
                            <li class="nav-item"><a class="nav-link" href="../admin/event-list.php"><span class="sidebar-text">Daftar Event</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="../admin/event-tambah.php"><span class="sidebar-text">Tambah Event</span></a></li>
                        </ul>
                    </div>
                </li>
